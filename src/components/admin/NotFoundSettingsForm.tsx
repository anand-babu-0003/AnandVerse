...
import { updateNotFoundPageDataAction, type UpdateNotFoundPageDataFormState } from '@/actions/admin/notFoundActions';
...
export default function NotFoundSettingsForm({ initialData }: { initialData: NotFoundPageData }) {
